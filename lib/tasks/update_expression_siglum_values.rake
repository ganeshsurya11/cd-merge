...
## Jira ticket - https://carlstahmer.atlassian.net/browse/CEB-14
...
# rake utility:update_expression_siglum_values

namespace :utility do
  desc "Update Expression Siglums"
	task :update_expression_siglum_values => :environment do
    Expression.all.each do |exp|
      new_exp_siglum_val = exp.work.work_siglum rescue nil
      if new_exp_siglum_val
        puts "Updating Expression Siglum value for id##{exp.id}"
