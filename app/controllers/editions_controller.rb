...
class EditionsController < ApplicationController
  ...
  #include /lib/modules/edition_sidebar.rb
  include EditionSidebar
  layout "application"
  ...
  def show
    ...
    @bottom_nav_links =  makeLinks(@digital_edition.id)

    @title_nav_links = makeTitleLink(@digital_edition.id)
