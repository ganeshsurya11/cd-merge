...
class Role < ActiveRecord::Base
  attr_accessible :id, :role_description, :role_notes, :role_role
  has_many :manifestation_events_has_agents,  :inverse_of => :roles
  has_many :item_events_has_agents,  :inverse_of => :roles
end
