...
class Expression < ActiveRecord::Base
  belongs_to :expression_type, :inverse_of => :expressions
  belongs_to :work, :inverse_of => :expressions
  has_many :manifestations, through: :expressions_has_manifestations
  has_many :lines,  :inverse_of => :expressions
  has_many :transcriptions, :inverse_of => :expressions
  has_many :pages, through: :transcriptions
  attr_accessible :id, :expression_type_id, :expression_name, :expression_siglum, :expression_description, :expression_notes, :work_id
end
