...
class Agent < ActiveRecord::Base
  has_many :manifestation_events_has_agents,  :inverse_of => :agents
  has_many :item_events_has_agents,  :inverse_of => :agents
  attr_accessible :id, :agent_birth_year, :agent_death_year, :agent_first_name, :agent_last_name, :agent_middle_name, :agent_name_prefix, :agent_name_suffix, :agent_notes, :agent_viaf_id, :agent_viaf_link, :agent_viaf_type
end
