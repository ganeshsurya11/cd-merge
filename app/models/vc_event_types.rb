...
###############################################################################
class VcEventTypes < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_event_type_description, :vc_event_type_notes, :vc_event_type_type, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name
end
