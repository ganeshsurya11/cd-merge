...
###############################################################################
class DigitalEditionHasConcordanceEntry < ActiveRecord::Base
  attr_accessible :concordance_entry_id, :digital_edition_id, :line_id, :page_id
  belongs_to :digital_edition, :inverse_of => :digital_edition_has_concordance_entries
  belongs_to :concordance_entry, :inverse_of => :digital_edition_has_concordance_entries
  belongs_to :line, :inverse_of => :digital_edition_has_concordance_entries
end
