...
class ManifestationType < ActiveRecord::Base
  has_many :manifestations,  :inverse_of => :manifestation_type
  attr_accessible :id, :manifestation_type_description, :manifestation_type_notes, :manifestation_type_type
end
