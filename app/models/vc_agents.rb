...
###############################################################################
class VcAgents < ActiveRecord::Base
  attr_accessible :vc_agent_first_name, :vc_agent_last_name, :vc_agent_middle, :vc_agent_notes, :vc_agent_viaf_id, :vc_agent_viaf_link, :vc_agent_viaf_type, :vc_date_time_stamp, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name
end
