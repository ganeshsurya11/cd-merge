...
###############################################################################
class ManifestationEventsHasAgents < ActiveRecord::Base
  attr_accessible :id, :agent_id, :manifestation_event_id, :role_id
  belongs_to :agent,  :inverse_of => :manifestation_events_has_agents
  belongs_to :role,  :inverse_of => :manifestation_events_has_agents
  belongs_to :manifestation_event,  :inverse_of => :manifestation_events_has_agents
end
