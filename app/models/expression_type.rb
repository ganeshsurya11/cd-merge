...
###############################################################################
class ExpressionType < ActiveRecord::Base
  has_many :expressions,  :inverse_of => :expression_type
  attr_accessible :id, :expression_type_description, :expression_type_note, :expression_type_type
end
