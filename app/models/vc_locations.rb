...
###############################################################################
class VcLocations < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_id, :vc_location_ghetty_id, :vc_location_ghetty_name, :vc_location_latitude, :vc_location_longitude, :vc_location_name, :vc_user_action, :vc_user_id, :vc_user_name
end
