...
class Location < ActiveRecord::Base
  has_many :manifestation_events,  :inverse_of => :locations
  has_many :item_events,  :inverse_of => :locations
  attr_accessible :id, :location_ghetty_id, :location_ghetty_name, :location_latitude, :location_longitude, :location_name, :location_notes
end
