...
###############################################################################
class VcExpressions < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_expression_description, :vc_expression_name, :vc_expression_notes, :vc_expression_siglum, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name
end
