...
###############################################################################
class VcItemEvents < ActiveRecord::Base
  attr_accessible :vc_Item_event_day, :vc_Item_event_month, :vc_Item_event_year, :vc_agent_id, :vc_date_time_stamp, :vc_event_type_id, :vc_id, :vc_item_id, :vc_location_id, :vc_role_id, :vc_user_action, :vc_user_id, :vc_user_name
end
