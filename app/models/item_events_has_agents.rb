...
###############################################################################
class ItemEventsHasAgents < ActiveRecord::Base
  attr_accessible :id, :agent_id, :item_event_id, :role_id
  has_many :manifestation_events,  :inverse_of => :item_events_has_agents
  has_many :agents,  :inverse_of => :item_events_has_agents
  has_many :roles,  :inverse_of => :item_events_has_agents
end
