...
###############################################################################
class VcEntities < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_entity_name, :vc_entity_notes, :vc_entity_siglum, :vc_entity_standard_title, :vc_entity_standard_title_source, :vc_entity_viaf_work_id, :vc_entity_viaf_work_link, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name
end
