...
###############################################################################
class VcHoldingInstitutions < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_holding_institution_name, :vc_holding_institution_notes, :vc_holding_institution_siglum, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name
end
