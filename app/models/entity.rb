...
class Entity < ActiveRecord::Base
  attr_accessible :entity_name, :entity_notes, :entity_siglum, :entity_standard_title, :entity_standard_title_source, :entity_viaf_work_id, :entity_viaf_work_link
  has_many :transcriptions,  :inverse_of => :entities
  has_many :lines,  :inverse_of => :entities
end
