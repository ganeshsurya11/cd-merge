...
###############################################################################
class VcWorks < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name, :vc_work_name, :vc_work_notes, :vc_work_siglum, :vc_work_viaf_id, :vc_work_viaf_link
end
