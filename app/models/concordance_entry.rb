...
###############################################################################
class ConcordanceEntry < ActiveRecord::Base
  attr_accessible :concordance_entry_token, :concordance_entry_total, :concordance_stop
  has_many :digital_edition_has_concordance_entries, :inverse_of => :concordance_entry
  has_many :digital_edition_has_concordance_entry_totals, :inverse_of => :concordance_entry
end
