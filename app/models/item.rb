...
class Item < ActiveRecord::Base
  belongs_to :manifestation, :inverse_of => :items
  belongs_to :holding_institution, :inverse_of => :items
  has_many :digital_editions, :inverse_of => :items
  has_many :item_events,  :inverse_of => :items
  attr_accessible :holding_institution_id, :item_description, :item_notes, :item_shelfmark, :item_siglum, :manifestation_id
end