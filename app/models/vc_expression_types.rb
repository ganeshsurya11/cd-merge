...
###############################################################################
class VcExpressionTypes < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_expression_type_description, :vc_expression_type_note, :vc_expression_type_type, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name
end
