...
class Page < ActiveRecord::Base
  attr_accessible :id, :page_image, :page_notes, :page_page, :digital_edition_id, :page_asset, :page_tei
  mount_uploader :page_image, PageImageUploader
  belongs_to :digital_edition, :inverse_of => :pages
  has_many :transcriptions,  :inverse_of => :pages
  has_many :expressions, through: :transcriptions
  has_many :lines,  :inverse_of => :pages
end
