...
class Transcription < ActiveRecord::Base
  attr_accessible :id, :page_id, :transcription_file, :transcription_notes, :transcription_order, :transcription_tei, :transcription_text, :digital_edition_id, :expression_id, :work_id
  has_many :lines,  :inverse_of => :transcriptions
  belongs_to :page, :inverse_of => :transcriptions
  belongs_to :work, :inverse_of => :transcriptions
  belongs_to :expression, :inverse_of => :transcriptions
  belongs_to :digital_edition
  mount_uploader :transcription_file, TranscriptionFileUploader
end
