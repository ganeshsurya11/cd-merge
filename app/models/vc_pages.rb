...
###############################################################################
class VcPages < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_id, :vc_page_image, :vc_page_notes, :vc_page_page, :vc_user_action, :vc_user_id, :vc_user_name
end
