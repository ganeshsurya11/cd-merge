...
###############################################################################
class VcWorksHasExpressions < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_expression_id, :vc_id, :vc_user_action, :vc_user_id, :vc_user_name, :vc_work_id
end
