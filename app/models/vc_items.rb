...
###############################################################################
class VcItems < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_holding_institution_id, :vc_id, :vc_item_description, :vc_item_notes, :vc_item_shelfmark, :vc_item_siglum, :vc_manifestation_id, :vc_user_action, :vc_user_id, :vc_user_name
end
