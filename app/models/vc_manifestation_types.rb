...
###############################################################################
class VcManifestationTypes < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_id, :vc_manifestation_type_description, :vc_manifestation_type_notes, :vc_manifestation_type_type, :vc_user_action, :vc_user_id, :vc_user_name
end
