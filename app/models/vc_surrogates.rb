...
###############################################################################
class VcSurrogates < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_id, :vc_item_id, :vc_surrogate_active, :vc_surrogate_description, :vc_surrogate_local_title, :vc_surrogate_notes, :vc_user_action, :vc_user_id, :vc_user_name
end
