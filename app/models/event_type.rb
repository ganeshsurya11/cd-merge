...
class EventType < ActiveRecord::Base
  has_many :manifestation_events,  :inverse_of => :event_types
  has_many :item_events,  :inverse_of => :event_types
  attr_accessible :id, :event_type_description, :event_type_notes, :event_type_type
end
