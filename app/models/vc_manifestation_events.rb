...
###############################################################################
class VcManifestationEvents < ActiveRecord::Base
  attr_accessible :vc_agent_id, :vc_date_time_stamp, :vc_event_type_id, :vc_id, :vc_location_id, :vc_manifestation_event_day, :vc_manifestation_event_month, :vc_manifestation_event_year, :vc_manifestation_id, :vc_role_id, :vc_user_action, :vc_user_id, :vc_user_name
end
