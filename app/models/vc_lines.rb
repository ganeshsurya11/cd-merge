...
###############################################################################
class VcLines < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_entities_id, :vc_id, :vc_line_entity_order, :vc_line_page_order, :vc_line_plaintext, :vc_line_tei, :vc_page_id, :vc_surrogate_id, :vc_user_action, :vc_user_id, :vc_user_name
end
