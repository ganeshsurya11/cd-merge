...
###############################################################################
class VcManifestations < ActiveRecord::Base
  attr_accessible :vc_date_time_stamp, :vc_expression_id, :vc_id, :vc_manifestation_description, :vc_manifestation_notes, :vc_manifestation_siglum, :vc_manifestation_title, :vc_manifestation_type_id, :vc_user_action, :vc_user_id, :vc_user_name
end
