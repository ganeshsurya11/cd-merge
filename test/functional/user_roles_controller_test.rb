...
class UserRolesControllerTest < ActionController::TestCase
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post :create, user_role: { user_roles_notes: @user_role.user_roles_notes, user_roles_role: @user_role.user_roles_role }
    end
  ...
  test "should update user_role" do
    put :update, id: @user_role, user_role: { user_roles_notes: @user_role.user_roles_notes, user_roles_role: @user_role.user_roles_role }
    assert_redirected_to user_role_path(assigns(:user_role))
  end
