...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { event_type_description: @event_type.event_type_description, event_type_notes: @event_type.event_type_notes, event_type_type: @event_type.event_type_type }
    end
  ...
  test "should update event_type" do
    put :update, id: @event_type, event_type: { event_type_description: @event_type.event_type_description, event_type_notes: @event_type.event_type_notes, event_type_type: @event_type.event_type_type }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
